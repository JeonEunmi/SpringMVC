...
<script>
	$(document).ready(function() {
        ...
        $(".btnDelete").on("click", function() {
        	...
        	//최소기본급 확인
        	var min_basicPay = $(this).val();
        	
        	//번호, 직위명, 최소기본급 정보 출력
        	$("#positionDeleteModal #jobId").val(jobId);
        	$("#positionDeleteModal #job_title").val(content);
        	$("#positionDeleteModal #min_basicPay").val(min_basicPay);
        });
        ...
        $(".btnUpdate").on("click", function() {
        	...
        	$("#input #min_basicPay").val($(this).val());
		...
		<div class="panel panel-default" id="input">
			...
			<div class="panel-body" id="demo">
				<form role="form"
					...
					<div class="form-group">
						<input type="number" class="form-control" id="min_basicPay"
							name="min_basicPay" placeholder="최소기본급" required="required">
					</div>
					...
					<tbody>
						...
						<tr>
							...
							<button type="button"
									...
									data-toggle="modal" data-target="#positionDeleteModal" value="${j.min_basicPay}">삭제</button>
							</td>
							<td><button type="button"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="${pageContext.request.contextPath}/position/delete"
						...
						<div class="form-group">
							<input type="text" class="form-control" id="job_title"
								name="job_title" value="" readonly="readonly"
								placeholder="CONTENT">
						</div>
						<div class="form-group">
							<input type="number" class="form-control" id="min_basicPay"
								name="min_basicPay" value="" readonly="readonly"
